...
def __init__key_event(raw_dict: Union["ProducibleKeyEvent", "ConsumableKeyEvent"]):
    ...
    if modifier:
        ...
        if type(raw_dict["modifiers"]) == list:
            ...
            raw_dict["modifiers"]["mandatory"].append(modifier)
        else:
...
def translate_symbols(key: KeyCode) -> Tuple[KeyCode, Optional[Modifier]]:
    """ Symbols often:
